...
async def main():
    ...
    st.title("Claude Computer Use - Kali hakcer edition")
    ...
    with st.sidebar:
        ...
        st.text_area(
            ...
            help="Additional instructions to append to the system prompt. see kali/loop.py for the base system prompt.",
